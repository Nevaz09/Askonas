...
class Berita_model extends CI_Model {
	...
	public function populer($jenis_berita = 'Berita')
	{
		$this->db->select('*');
		$this->db->from('berita');
	...
	public function sub_layanan_admin($id_sub_layanan) {
		$this->db->select('berita.*, users.nama');
		$this->db->from('berita');
		// Join dg 2 tabel
		...
		$this->db->join('users','users.id_user = berita.id_user','LEFT');
		// End join
		$this->db->where(array(	'berita.id_sub_layanan'	=> $id_sub_layanan));
		$this->db->order_by('id_berita','DESC');
		$query = $this->db->get();
		return $query->result();
	}
	...
	// Listing profil
	public function listing_profil($limit=20,$start=0) {
		$this->db->select('berita.*, users.nama');
		$this->db->from('berita');
		// Join dg 2 tabel
	...
	// Listing layanan
	public function listing_layanan($limit=20,$start=0) {
		$this->db->select('berita.*, users.nama');
		$this->db->from('berita');
		// Join dg 2 tabel
	...
	public function listing_tips($limit=20,$start=0) {
		$this->db->select('berita.*, users.nama');
		$this->db->from('berita');
		// Join dg 2 tabel
	...
	public function listing_kegiatan($limit=20,$start=0) {
		$this->db->select('berita.*, users.nama');
		$this->db->from('berita');
		// Join dg 2 tabel
