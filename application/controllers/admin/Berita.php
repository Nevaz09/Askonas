...
class Berita extends CI_Controller {
	...
	public function sub_layanan($id_sub_layanan)	{
		$berita 	= $this->berita_model->sub_layanan_admin($id_sub_layanan);
		$sub_layanan 	= $this->sub_layanan_model->detail($id_sub_layanan);

		$data = array(	'title'			=> 'Kategori berita: '.$sub_layanan->nama_sub_layanan.' ('.count($berita).')',
						'berita'		=> $berita,
	...
	public function tambah()	{
		...
		// Masuk database
	        ...
	        $data = array(	'id_kategori'	=> $i->post('id_kategori'),
					'id_sub_layanan'	=> $i->post('id_sub_layanan'),
