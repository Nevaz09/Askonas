                                    ...
                                    <div class="blog-content-box">
                                        <div class="blog-content">
                                            ...
                                            <ul class="meta-post">
                                                ...
                                                <li><i class="fa fa-list-alt"></i> <?php echo $berita->jenis_berita; ?></li>
                                                ...
                                                <?php foreach($populer as $populer) { ?>
                                                    <li>
                                                        <div class="popular-news-img" style="width: 80px; height: 80px;">
                                                            <a href="#"><img src="<?php if($populer->gambar=="") { echo base_url('assets/upload/image/'.$site->icon); }else{ echo base_url('assets/upload/image/'.$populer->gambar); } ?>" alt="popular-news-img-1" /></a>
                                                        </div>
                                                        <!-- .popular-news-img -->
