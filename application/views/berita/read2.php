            ...
            <?php foreach($listing as $listing) { ?>
              ...
              <li class="media">
                <div class="media-left">
                  <a href="<?php echo base_url('berita/read/'.$listing->slug_berita) ?>"><img src="<?php echo base_url('assets/upload/image/'.$listing->gambar) ?>" alt="<?php echo $listing->judul_berita ?>" width="70"></a>
                </div>
