                                        ...
                                        <?php foreach($listing as $listing) { ?>
                                            <li>
                                                <div class="popular-news-img" style="width: 80px; height: 80px;">
                                                    <a href="#"><img src="<?php if($listing->gambar=="") { echo base_url('assets/upload/image/'.$site->icon); }else{ echo base_url('assets/upload/image/'.$listing->gambar); } ?>" alt="popular-news-img-1" /></a>
                                                </div>
                                                <!-- .popular-news-img -->
