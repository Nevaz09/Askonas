<div class="row">
	<div class="col-md-7">
		...
		<p class="text-center">
			<img src="<?php if($user->gambar =="") { echo $this->website->icon(); }else{ echo base_url('assets/upload/user/'.$user->gambar); } ?>" style="max-width: 150px; height: auto;" class="img img-circle img-thumbnail">
		</p>
