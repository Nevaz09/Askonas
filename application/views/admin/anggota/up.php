...
<div class="btn-group">
    ...
    <a href="<?php echo base_url('admin/anggota') ?>" class="btn btn-info btn-lg">
  ...
  <tr>
    ...
    <td>
      <div class="btn-group">
        ...
        <a href="<?php echo base_url('admin/anggota/delete_up/'.$up->id_up.'/'.$anggota->id_anggota) ?>" class="btn btn-danger btn-sm" onclick="confirmation(event)"><i class="fa fa-trash-o"> Delete</i></a>
      </div>
