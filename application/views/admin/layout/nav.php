    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          echo $this->website->icon(); }else{ echo base_url('assets/upload/user/'.$user_aktif->gambar); } ?>" class="img-circle elevation-2" alt="<?php echo $this->session->userdata('nama'); ?>">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item"><a href="<?php echo base_url('admin/sub_layanan') ?>" class="nav-link"><i class="fa fa-tags nav-icon"></i><p>Sub Layanan Berita</p></a>
              </li>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>Pesan &amp; Email <i class="right fa fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="<?php echo base_url('admin/pesan') ?>" class="nav-link"><i class="fa fa-table nav-icon"></i><p>Data Pesan</p></a>
              </li>
              <li class="nav-item"><a href="<?php echo base_url('admin/email') ?>" class="nav-link"><i class="fa fa-envelope nav-icon"></i><p>Data Email</p></a>
              </li>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>Cabang <i class="right fa fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="<?php echo base_url('admin/cabang') ?>" class="nav-link"><i class="fa fa-table nav-icon"></i><p>Data Cabang</p></a>
              </li>
              <li class="nav-item"><a href="<?php echo base_url('admin/cabang/tambah') ?>" class="nav-link"><i class="fa fa-plus nav-icon"></i><p>Tambah Cabang</p></a>
              </li>
