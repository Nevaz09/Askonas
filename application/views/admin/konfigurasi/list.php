...
<div class="col-md-6">
   ...
   <input type="url" name="instagram" placeholder="http://instagram.com/namakamu" value="<?php echo $site->instagram ?>" class="form-control">
    ...
    <div class="form-group">
    <label>Instagram <i class="fa fa-instagram"></i></label>
   <input type="url" name="widget_instagram" placeholder="http://instagram.com/p/idpostinganmu/" value="<?php echo $site->widget_instagram ?>" class="form-control">
    </div>

    <div class="form-group">
    <label>Youtube <i class="fa fa-youtube"></i></label>
   <input type="url" name="youtube" placeholder="http://youtube.com/channel/idyoutubekamu" value="<?php echo $site->youtube ?>" class="form-control">
    </div>
