...
<tr class="odd gradeX">
    ...
    <?php if($berita->gambar!="") { ?>
      ...
      <?php }else{ ?>
      <img src="<?php echo base_url('assets/upload/image/'.$site->icon) ?>" class="img img-thumbnail img-responsive" width="60">
      <?php } ?>
    </td>
    <td>
    ...
    <?php echo (isset($berita->nama_kategori) ? $berita->nama_kategori : $kategori->nama_kategori); ?><sup><i class="fa fa-link"></i></sup>
    </a>
    </td>
    <td>
