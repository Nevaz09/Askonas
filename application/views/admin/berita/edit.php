...
<select name="jenis_berita" class="form-control">
  ...
  <option value="Tips"  <?php if($berita->jenis_berita=="Tips") { echo "selected"; } ?>>Tips</option>
  <option value="Kegiatan"  <?php if($berita->jenis_berita=="Kegiatan") { echo "selected"; } ?>>Kegiatan</option>
</select>
...
<div class="form-group">
<label>Sub Layanan Berita</label>
<select name="id_sub_layanan" class="form-control">
    <option value="">Tanpa Sub Layanan</option>
	<?php foreach($sub_layanan as $sub_layanan) { ?>
	<option value="<?php echo $sub_layanan->id_sub_layanan ?>"  <?php if($berita->id_sub_layanan==$sub_layanan->id_sub_layanan) { echo "selected"; } ?>>
	<?php echo $sub_layanan->nama_sub_layanan ?></option>
	<?php } ?>
